...
(define (make-named-object name)  ; symbol -> named-object
  (let ((root-part (make-root-object)))
	...
	((INSTALL) (lambda (self) 'INSTALLED)) ;; > installed
	((DESTROY) (lambda (self) 'DESTROYED)) ;; > destroyed
...
(define (create-named-object name)
  (create make-named-object name))  ;create maker . args
;IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
...
;IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII	  
(define (find-exit-in-direction exits dir)  ;Used in place
...
;IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII			  
(define (random-exit place)        ;;Used in autonomouses and trolls			  
